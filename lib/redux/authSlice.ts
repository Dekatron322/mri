...
export const signupUser = createAsyncThunk("auth/signup", async (signupData: SignupRequest, { rejectWithValue }) => {
  try {
    const response = await api.post<SignupResponse>(buildApiUrl(API_ENDPOINTS.AUTH.SIGN_UP), signupData)

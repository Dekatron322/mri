...
export const ButtonModule: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "flex z-0 items-center justify-center overflow-hidden rounded-full font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2"
  ...
  const variantClasses = {
    ...
    secondary:
      "bg-[#ffffff] text-[#1447E6] hover:bg-[#D8D6F5] focus:ring-[#1447E6] border-[#1447E6] border focus-within:ring-2 focus-within:ring-[#1447E6] focus-within:ring-offset-2",
